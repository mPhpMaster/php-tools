...
/**
 * Trait HasAttributesWithString
 * like Percentage
 *
 * @mixin \Modules\Tools\Interfaces\IHasAttributesWithString
...
trait THasAttributesWithString
{
     ...
     * @return \Closure
     */
    public static function getWithStringTransformer(): \Closure
    {
    ...
    public function withString($string = null, $value = null) {
        ...
        return new class ($this, $string) {
            /** @var \Modules\Tools\Traits\THasAttributesWithString $class */
            protected $class;
            /** @var string $string */
            public $string;
    ...
    public function suffixWithString($value, $stringName, callable $formatter = null): string
    {
        ...
        $formatter = is_callable($formatter) ? $formatter : static::getWithStringTransformer();
