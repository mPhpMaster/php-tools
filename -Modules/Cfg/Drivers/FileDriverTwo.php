...
namespace Modules\Cfg\Drivers;

/**
 * Class FileDriver.
 */
class FileDriverTwo extends AbstractDriver
{
    /**
    ...
    {
        $this->file = cfg('FileDriverTwo.file.path', module_path('Cfg') . "\Config\FileDriverTwo.json");
